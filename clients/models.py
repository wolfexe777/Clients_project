...
class Client(models.Model):
    ...
    workplace = models.CharField(blank=True, null=True, max_length=100, verbose_name='Место работы')
    position = models.CharField(blank=True, null=True, max_length=100, verbose_name='Должность')
    children = models.TextField(blank=True, null=True, max_length=255, verbose_name='Семейное положение, дети')
    life_events = models.TextField(blank=True, null=True,max_length=255, verbose_name='Жизненные события клиента')
    illnesses = models.TextField(blank=True, null=True, verbose_name='Заболевания, жалобы клиента')
    diagnosis = models.CharField(blank=True, null=True, max_length=100, verbose_name='Диагноз')
